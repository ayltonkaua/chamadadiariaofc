...
import { alunoService, presencaService, atestadosService, type Aluno } from '@/domains';
...
export default function AlunoPage() {
  ...
  useEffect(() => {
    const fetchAlunoData = async () => {
      ...
      try {
        ...
        setHistoricoCompleto(historicoData as Presenca[]);
        // Filtrar atestados para este aluno
  ...
  // CORREÇÃO DA DATA: Garante que a data seja interpretada no fuso horário local
