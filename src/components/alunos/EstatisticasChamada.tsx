...
export const EstatisticasChamada: React.FC<EstatisticasChamadaProps> = ({ historico }) => {
    ...
    const chamadasMesAtual = historico.filter(chamada => {
        // parseISO garante que a string YYYY-MM-DD seja lida corretamente no fuso local
        const dataChamada = parseISO(chamada.data);
    ...
    // Ordenação: historico[0] é a mais recente, historico[length-1] a mais antiga
    const dataInicio = historico[historico.length - 1].data;
    const dataFim = historico[0].data;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-sm text-gray-500">
                        De {format(parseISO(dataInicio), "dd/MM/yyyy")} a {format(parseISO(dataFim), "dd/MM/yyyy")}
                    </p>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-2xl font-bold">
                        {format(parseISO(diaMaisFaltas.data), "dd/MM/yyyy")}
                    </p>
                    <p className="text-sm text-gray-500">
